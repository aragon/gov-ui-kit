...
-   Update `ProposalVotingStage` module component to accept new optional `bodyList` prop and adjusted rendering logic to handle multi body proposals per stage.
