...
export const RadioCard = forwardRef<HTMLButtonElement, IRadioCardProps>((props, ref) => {
    ...
    const containerClasses = classNames(
        'group flex w-full flex-col gap-3 rounded-xl border border-neutral-100 bg-neutral-0 px-4 py-3 shadow-neutral-sm outline-hidden transition-all md:rounded-2xl md:px-6 md:py-4', // default
